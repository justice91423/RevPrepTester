...
Page.prototype.fillNewLeadSource= function(name=false, category="Business"){
	...
	//enter category
	.then(() => this.selectOption(category,newLeadSourceModalSelector.categoryField,"xpath"))
	//enter  phone
	.then(() => this.clickClearWrite(ranphone, newLeadSourceModalSelector.leadSourcePhoneField,'xpath'))
	.then(() => sleep(200))
	// add some notes
	.then(() => this.clickClearWrite("This is a "+category, newLeadSourceModalSelector.notesField,'xpath'))
}
