...
var Page = function(browser){
	...
	// this.findAll = function(el,by='tagName'){

	// 	if (by == 'css'){
	// 		// driver.wait(until.elementLocated(By.css(el)));
	// 		var foundElements = driver.findElements(By.css(el));
	...
	// 		var foundElements = driver.findElements(By.xpath(el));
	// 		// driver.wait(until.elementIsVisible(foundElement), 10000);
	// 		// return foundElement;
	// 	}
	// 	if (by == 'id'){
	// 		// driver.wait(until.elementLocated(By.id(el)));
	// 		var foundElements = driver.findElements(By.id(el));
	// 		// driver.wait(until.elementIsVisible(foundElement), 10000);
	// 		// return foundElement;
	// 	}
	// 	if (by == 'name'){
	// 		// driver.wait(until.elementLocated(By.name(el)));
	// 		var foundElements = driver.findElements(By.name(el));
	// 		// driver.wait(until.elementIsVisible(foundElement), 10000);
	// 		// return foundElement;
	// 	}
	// 	if (by == 'tagName'){
	// 		// driver.wait(until.elementLocated(By.name(el)));
	// 		var foundElements = driver.findElements(By.tagName(el));
	// 		// driver.wait(until.elementIsVisible(foundElement), 10000);
	// 		// return foundElement;
	// 	}
	// 	// if (by == 'title'){
...
Page.prototype.selectOption = function(item, selector, by="css",tagName="option"){
    ...
    // this.debug("into selectButtonOption("+item+", "+selector+", "+by+", "+tagName+")")
        ...
        .then(function findMatchingOption(options){
            ...
            options.some(function(option){
                ...
                option.getText().then(function doesOptionMatch(text){
                    ...
                    if (item === text){
                    	// this.debug("Got it target "+"."+item+"."+" text " + "."+text+".")
