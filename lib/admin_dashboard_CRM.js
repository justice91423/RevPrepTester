...
Page.prototype.clickXtoCloseCRM = function(item=false){
	this.find("/html/body/div[1]/div/div/parent-crm-modal/div/div[1]/button",'xpath').click()
}
...
// 		// console.log(this.randomString(10,"alpha"));
// }
