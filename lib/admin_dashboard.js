...
Page.prototype.clickNavBarItem = function(navBarItemCounter=false,navBarSectionCounter=false,navBarSectionItemCounter=false){
	...
	// navBarItemCounter identifies a NONE expandable navbar item (Home = 1, Call list = 2, etc.)
	...
	// SectionPositionCounter identifies the expandable navbar item (Advisor = 1, teams = 2, etc.)
...
Page.prototype.clickAdvisorOption = function(option){
	...
	.then(() => this.find("/html/body/div[3]/div/a["+option+"]",'xpath').click());
}
