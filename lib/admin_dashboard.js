...
Page.prototype.clickAdvisorOption = function(option){
	...
	// .then(() => this.find("/html/body/div[5]/div/a["+option+"]",'xpath').click());
...
// /html/body/div[7]/div/a[3]
// /html/body/div[4]/div/a[3]
// /html/body/div[4]/div/a[3]
// /html/body/div[4]/div/a[3]
// this.find('//a[@href="https://admin.rev-prep.com/courses/23941"]','xpath').click()
...
Page.prototype.clickUserNameAdminDashboard = function(option){
	return this.find("/html/body/ui-view/app/div/div/sidebar/nav/div/div[10]/a",'xpath').click()
}
