...
// var sourceFile = require('../lib/admin_dashboard_xpaths.js');
var newLeadModalSelector = require('../lib/admin_dashboard_xpaths.js').newLeadModalXpaths;


Page.prototype.fillNewLead = function(firstName=false,lastName=false,email=false,leadSource="Gift Card",courseID="nothing"){
	...
	.then(() => this.selectOption("Pre-Conversation",newLeadModalSelector.statusField,'xpath'))
	// add some notes
